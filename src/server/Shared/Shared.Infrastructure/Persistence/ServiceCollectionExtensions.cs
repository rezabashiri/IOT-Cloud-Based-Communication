...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddDatabaseContext<T>(this IServiceCollection services,
        ...
        where T : DbContext
    {
        var options = services.GetOptions<PersistenceSettings>(
            nameof(PersistenceSettings),
            configuration);
        ...
        {
            string connectionString = options.ConnectionStrings.Sqlite;
            services.AddSqlite<T>(connectionString);
        }

        return services;
    }

    private static IServiceCollection AddSqlite<T>(this IServiceCollection services,
    ...
    private static IServiceCollection AddMSSQL<T>(this IServiceCollection services,
        string connectionString)
        where T : DbContext
    {
        services.AddDbContext<T>(
    ...
    private static IServiceCollection AddInMemoryDataBase<T>(this IServiceCollection services,
        string name)
        where T : DbContext
    {
